#!/bin/bash
#SBATCH --job-name=WH_HG002_uf_uf
...
apptainer exec \
 ...
 whatshap phase -o /hpc/umc_laat/gvandersluis/data/Ont_data_nhung/${SAMPLE}/un_unfiltered_ROI/phased_ROI.vcf \
 --reference=/hpc/umc_laat/resources/refgenomes/GCA_000001405.15_GRCh38_no_alt_analysis_set.fasta \
 /hpc/umc_laat/gvandersluis/data/Ont_data_nhung/${SAMPLE}/un_unfiltered_ROI/Sample_un_unfiltered_ROI.vcf.gz \
